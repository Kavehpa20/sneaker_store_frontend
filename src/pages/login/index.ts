...
export const loginPage = () => {
  ...
  <div class="ml-4 mt-4"> <a href="onboarding" class="cursor-pointer">
  ...
  <p class="text-3xl font-medium mt-14 mb-8">Login to Your Account</p>
      
  </div>

  <form class="flex flex-col justify-center items-center" id="login-form">
    ...
    <div class="relative mb-6 w-11/12 ">
      ...
      <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
          <button type="button" class="hidden" id="hide-password"> 
  ...
  <path fill="currentColor"
    d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z">
          ...
          <button type="form" class="" id="show-password">
  <svg class="h-6 text-gray-700" fill="none" @click="show = !show"
  ...
  <path fill="currentColor"
    ...
    <button onClick="navigate('/signup')" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Do not have a account? SignUp</button>

    <div class="p-4 mt-4 text-sm text-red-800 rounded-lg bg-red-100 hidden" role="alert" id="login-form-error"></div>

    <div class="p-4 mt-4 text-sm text-green-800 rounded-lg bg-green-100 hidden" role="alert" id="login-form-success"></div>
...
export const loginPageFunc = () => {
  const form = <HTMLFormElement> document.getElementById('login-form');
  const errorAlert = <HTMLDivElement> document.getElementById('login-form-error');
  const successAlert = <HTMLDivElement> document.getElementById('login-form-success');
  const showPassword = <HTMLButtonElement> document.getElementById('show-password');
  const hidePassword = <HTMLButtonElement>  document.getElementById('hide-password');
  ...
  try {
    ...
    successAlert.innerText = 'You login to your account successfully';
